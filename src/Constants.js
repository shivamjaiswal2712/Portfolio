...
export const PROJECTS = [
  ...
  },
  {
    ...
    description: "Weather forecasting is the application to predict the state of the atmosphere for a future time and a given location. Weather is the state of the atmosphere like cold and hot.",
